...
TransposedSummary_SurveyDatesByYearDataFrame = t(Summary_SuccessByYearDataFrame) # Transpose the data frame
colnames(TransposedSummary_SurveyDatesByYearDataFrame)[1] = "Result" # Rename the wierd first column with no name that R stuck in
...
```{r echo=FALSE}
kable(TransposedSummary_SurveyDatesByYearDataFrame) # Output the transposed table
...
tSummary_SuccessByYearAndRiverSegmentDataFrame = t(Summary_SuccessByYearAndRiverSegmentDataFrame)
