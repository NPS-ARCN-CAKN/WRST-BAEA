...
YngPerOccupiedNest = signif(Summary_SuccessByYearDataFrame_Current$`Young/occupied nest`,2)
YngPerSuccessfulNest = signif(Summary_SuccessByYearDataFrame_Current$`Young/successful nest`,2)
...
```{r echo=FALSE,label="Percent nest success by year",fig.alt=FigureCaption,fig.cap=FigureCaption}
...
```{r echo=FALSE,label="Productivity by year plot",fig.alt=FigureCaption,fig.cap=FigureCaption}
...
# Make a caption for the table
# TableCaption = paste("Table ",TableCounter,". Long term bald eagle nesting success and productivity in the ",Segment," river segment.",sep="")

# Show the metrics for the river segment
# kable(GetSummaryByRiverSegment(Segment),caption=TableCaption)
...
```{r echo=FALSE,fig.alt=FigureCaption,fig.cap=FigureCaption}
