...
#Output
kable(CurrentSummaryDF_char_DF,col.names=c("Metric","Result"), caption=paste("Table ",TableCounter,". Results summary, ",SurveyYear," bald eagles survey.",sep=""))
...
ProductivityDataFrame[is.na(ProductivityDataFrame)] = " "
...
```{r echo=FALSE,label="Young/successful nest",fig.alt=paste("Figure ",FigureCounter,". Historical productivity (young per nest) over the entire Copper River study area. Mean young/successful nest = ",MeanYoungPerSuccessfulNest,". Mean young/occupied nest = ",MeanYoungPerOccupiedNest," (full success and productivity metrics table is in the Appendix).",sep=''),fig.cap=paste("Figure ",FigureCounter,". Historical productivity (young per nest) over the entire Copper River study area. Mean young/successful nest = ",MeanYoungPerSuccessfulNest,". Mean young/occupied nest = ",MeanYoungPerOccupiedNest," (full success and productivity metrics table is in the Appendix).",sep='')}
