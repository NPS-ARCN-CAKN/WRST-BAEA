...
SurveyYear = 2010  # Set this to the desired report year
...
ggplot() +
  ...
  geom_point(data=ProductivityDataFrame, aes(x = Longitude, y = Latitude,colour=Status,na.rm = TRUE,shape=Status),size=3) +
...
Figure `r FigureCounter`. Nest success by year and river segment (No data on productivity by river segment before 2004).
...
Figure `r FigureCounter`. Young per successful nest by year and river segment (No data on productivity by river segment before 2004).
