...
Bald eagle monitoring has been done from 1989 through `r MaxYear` (Table 3). Long-term mean occupancy has been `r MeanOccupancyByYear`% and mean nest success has ranged between `r MinSuccessByYear`% and `r MaxSuccessByYear`%, averaging `r MeanSuccessByYear`%.

Table `r TableCounter`. Long-term bald eagle productivity metrics in WRST by river segment.
