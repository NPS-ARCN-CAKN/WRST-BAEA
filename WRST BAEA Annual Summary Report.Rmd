...
SurveyYear = 2016  # Set this to the report year
```
...
--, Nest_O
FROM         Dataset_Productivity
WHERE   ([Lat-NAD83] IS NOT NULL) AND ([Lat-NAD83] > 50) AND (StatusCode_P IN ('S', 'IF'))
",sep='')
...
# 
#   # Productivity data
#   geom_point(data=Yng1, aes(x = Longitude, y = Latitude,colour=NumYng),color="gold",size=2,show.legend = TRUE) +
#   geom_point(data=Yng2, aes(x = Longitude, y = Latitude,colour=NumYng),color="darkgreen",size=3,show.legend = TRUE) +
