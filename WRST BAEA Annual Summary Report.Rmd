...
SurveyYear = 2008  # Set this to the desired report year
...
Parks = read_sf(paste(ShpPath,"AKParks_reprojected.shp",sep=""))
...
ggplot() +
  ...
  scale_color_manual(values = c("Succeeded" = "blue", "Failed" = "gray")) +
