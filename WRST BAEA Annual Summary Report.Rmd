...
Results for the `r SurveyYear` bald eagle survey in WRST appear in Table `r TableCounter`. Success and productivity metrics are reported in Table `r TableCounter + 1`. `r NestsLocated` nests were located during the survey. Of these nests, `r Occupied` were occupied and `r Successful` produced young.
