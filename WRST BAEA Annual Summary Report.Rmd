...
FigureCaption = paste("Figure ",FigureCounter,". Dispersion of successful bald eagle nests in the Copper River Valley in in ",SurveyYear,". Green areas show areas where nests were most successful at producing young. Mean occupancy rate was ",MeanOccupancy,"% and mean success rate was ",MeanSuccess,"%.",sep='')
...
# Make a figure caption
FigureCaption = paste("Figure ",FigureCounter,". Productivity of successful bald eagle nests in the Copper River Valley in in ",SurveyYear,". Mean productivity of occupied nests was ",MeanYoungPerOccupiedNest," young per nest and mean productivity of successful nests was ",MeanYoungPerSuccessfulNest," young per nest.",sep='')
...
Figure `r FigureCounter`. Nest success by year: Entire study area (`r lmstats`. Mean nest success [dashed line]=`r MeanSuccess`%). Data in Appendix.
...
# Appendix B: Extended information about the survey
...
```{r echo=FALSE, label = "Appendix B: Supplementary information"}
