...
### QC: Active nests with DateDiscoveredGone is not NULL
...
## QC: Nests With No Productivity Observation
...
## QC: Chick Age Recorded But No Young Recorded
...
```{r echo=FALSE}
Sql = paste("SELECT * FROM QC_ChickAgeButNoYoung WHERE Year = ",SurveyYear,sep='')
df = GetDataFrameFromDatabase(Sql)
kable(df)
...
## QC: Active nests that possibly should be inactive
...
## QC: Successful Nests With No Recorded Young
...
## QC: Active nests that were not search for during the latest survey
...
## QC: Records from the latest survey that have initiated nests, but no follow up productivity information
...
## QC: Possibly mistaken nest initiation decisions
...
## QC: Nests marked successful that did not produce any young
